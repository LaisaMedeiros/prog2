...
void mergesort3 (int p, int r, int v[]) {
	...
	if (p < r-1) {
		int q = (p + r - 1) / 2; //q é o meio
		mergesort3 (p, q, v); //chama a função para a primeia metade
	
		mergesort3 (q, r, v); // ta errado, pois deveria ser q+1, o elmento na posição q estará
